...
<div style="display: flex; justify-content: space-between; align-items: center; margin: 40px 0; padding: 20px; background: #f5f5f5; border-radius: 8px; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 150px;">
    ...
    <p style="margin: 5px 0 0 0;">
      <a href="../cursor/quick-reference.md" style="color: #0366d6; text-decoration: none; font-weight: 500;">← Cursor 快速参考手册</a>
    </p>
  </div>
  ...
  <div style="flex: 1; text-align: right; min-width: 150px;">
    ...
    <p style="margin: 5px 0 0 0;">
      <a href="../vibe-coding/prompt-engineering.md" style="color: #0366d6; text-decoration: none; font-weight: 500;">Prompt 工程完全指南 →</a>
    </p>
  </div>
</div>
